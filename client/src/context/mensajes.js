export const mensajes = [
    ...
    },
    {
      ...
      max: 99.99,
      texts: [
        "¡Estás a un paso del éxito! Has completado el 90% de tus metas. Un último esfuerzo y habrás terminado.",
        "90% alcanzado. Tu determinación te ha traído hasta aquí, termina con fuerza.",
        "La línea de meta está a la vista. Dale ese último empujón, lo tienes al alcance.",
        "Estás rozando el éxito. Mantén el enfoque, estás a punto de lograrlo todo."
      ]
    },
    {
      min: 100,
      max: 100,
      texts: [
        "¡Lo lograste! Has completado todas tus actividades de hoy. Celebra este éxito y sigue adelante con determinación.",
        "¡Felicidades por alcanzar el 100%! Tu dedicación ha dado frutos.",
        "Has demostrado un compromiso excepcional. Disfruta de tu logro.",
        "¡Victoria total! Has superado todos los desafíos de hoy. Estás imparable.",
        "Es todo por hoy campe@n !Felicidades por lograr tus metas!"
      ]
    }
  ];